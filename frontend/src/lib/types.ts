...
export interface PacketEvent { id: string; agent_id: string; timestamp: string; interface: string; source: string; destination: string; source_port: number | null; destination_port: number | null; protocol: string; tcp_flags: string; packet_size: number; ttl: number | null; received_at: string; risk: number; severity: string; }
